 ...
 * @return {Component} => Render a UserPage to show the information of current login user.
 */
...
/**
 * Has similar funtionality as the ImagePicker component in PublishPage.js but this is speific to change the avatar with special style.
 * 
 * @private
 * @param {{user: {photoUrl: String}}} props props.user.photoUrl is used to render the avatar.
 * @return {Component} => Render a ImagePicker to change avatar.
 */
